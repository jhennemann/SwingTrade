...
import { getOpenTrades, getClosedTrades, getEquityCurve, getAccountSummary, getTradeStats } from '../paperTrades.js'
...
// ── Stat card reusing existing site style ─────────────────────────────────────
...
export default function PaperTradingPage() {
  ...
  return (
    <div>
      ...
      {/* ── Account summary stat cards — one row per config ── */}
                    ...
                    return (
                      <tr key={t.id}>
                        <td>
                          <span style={{
                            fontSize: '0.72rem',
                            color: CONFIG_META[t.config]?.color ?? '#888',
                            fontWeight: 600,
                            textTransform: 'capitalize',
                          }}>
              ...
              <ResponsiveContainer width="100%" height={340}>
                <LineChart data={chartData} margin={{ top: 8, right: 16, bottom: 8, left: 24 }}>
                  ...
                  <Line
                    ...
                    stroke={CONFIG_META.conservative.color}
                    strokeWidth={2}
                    dot={false}
                    activeDot={{ r: 4 }}
                  />
                  <Line
                    type="monotone"
                    dataKey="aggressive"
                    stroke={CONFIG_META.aggressive.color}
                    strokeWidth={2}
                    dot={false}
                    activeDot={{ r: 4 }}
                  />
